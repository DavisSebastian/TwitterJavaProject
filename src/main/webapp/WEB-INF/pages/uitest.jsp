<html lang="en" class=""><head>
      ...
      <style class="INLINE_PEN_STYLESHEET_ID">
         ...
         --cs-surface-2: #eef4f8;
         --cs-separator: #e8ecf0;
         --cs-on-surface-primary: #a5a1a1;
         --cs-on-surface-secondary: #2a06f2;
   ...
   <style></style><style></style><style></style><style></style></head>
   <body>
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        <div class="feed_header">
                           <h1 class="feed_title">Recomendations for you</h1>
                        </div>
